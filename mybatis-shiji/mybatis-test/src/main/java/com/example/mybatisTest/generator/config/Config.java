package com.example.mybatisTest.generator.config;
...
public class Config {
    ...
    /** 作者 */
    public static final String AUTHOR = "屈燃希";

    /** 基础包名 */
    public static final String PACKAGE_NAME = "com.example.mybatisTest.web";

    /** 生成文件的输出目录 */
    public static String PROJECT_PATH = "mybatis-test";
    ...
    /** 数据库链接 */
    public static final String DB_URL = "jdbc:mysql://192.168.150.132:3306/hq-word?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true";

    /** 数据库用户名 */
    public static final String USERNAME = "root";

    /** 数据库密码 */
    public static final String PASSWORD = "QURANxi#123+456%";

    /** 数据库驱动 */
    public static final String DRIVER = "com.mysql.cj.jdbc.Driver";

    /** 表名，为空，生成所有的表 */
    public static final String[] TABLE_NAMES = {"app_folder"};
