...
public class GetAddCodeGenProcessor extends BaseCodeGenProcessor {


  public  static  final String PREFIX ="Add";

  public  static  final String PREFIX_BEHAVIOR="添加";

  public static final String SUFFIX = "Param";

  @Override
  public Class<? extends Annotation> getAnnotation() {
    return GenAddParam.class;
  }

  @Override
  public String generatePackage(TypeElement typeElement) {
    return typeElement.getAnnotation(GenAddParam.class).pkgName();
  }
  ...
  protected void generateClass(TypeElement typeElement, RoundEnvironment roundEnvironment) {
    ...
    Set<VariableElement> fields = findFields(typeElement,
        ve -> Objects.isNull(ve.getAnnotation(GenAddParam.class)));
...
//    genJavaFile(packageName, getSourceTypeWithConstruct(typeElement,sourceClassName, packageName, className));
    genJavaSourceFile(packageName,typeElement.getAnnotation(GenAddParam.class).sourcePath(),builder);
  }
}
