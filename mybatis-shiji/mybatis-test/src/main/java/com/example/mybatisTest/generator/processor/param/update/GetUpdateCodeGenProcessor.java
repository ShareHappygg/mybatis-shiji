...
public class GetUpdateCodeGenProcessor extends BaseCodeGenProcessor {


  public  static  final String PREFIX ="Update";

  public  static  final String PREFIX_BEHAVIOR="更新";

  public static final String SUFFIX = "Param";

  @Override
  public Class<? extends Annotation> getAnnotation() {
    return GenUpdateParam.class;
  }

  @Override
  public String generatePackage(TypeElement typeElement) {
    return typeElement.getAnnotation(GenUpdateParam.class).pkgName();
  }
  ...
  protected void generateClass(TypeElement typeElement, RoundEnvironment roundEnvironment) {
    ...
    Set<VariableElement> fields = findFields(typeElement,
        ve -> Objects.isNull(ve.getAnnotation(GenUpdateParam.class)));
...
//    genJavaFile(packageName, getSourceTypeWithConstruct(typeElement,sourceClassName, packageName, className));
    genJavaSourceFile(packageName,typeElement.getAnnotation(GenUpdateParam.class).sourcePath(),builder);
  }
}
