...
public class GetListCodeGenProcessor extends BaseCodeGenProcessor {


  public  static  final String PREFIX ="GetList";

  public  static  final String PREFIX_BEHAVIOR="获取";

  public static final String SUFFIX = "Param";

  @Override
  public Class<? extends Annotation> getAnnotation() {
    return GenGetParam.class;
  }

  @Override
  public String generatePackage(TypeElement typeElement) {
    return typeElement.getAnnotation(GenGetParam.class).pkgName();
  }
  ...
  protected void generateClass(TypeElement typeElement, RoundEnvironment roundEnvironment) {
    ...
    Set<VariableElement> fields = findFields(typeElement,
        ve -> Objects.isNull(ve.getAnnotation(IgnoreGenGetParam.class)));
    ...
    addGetListParamMetHod(builder, fields,typeElement.getAnnotation(GenGetParam.class).isPage());
...
//    genJavaFile(packageName, getSourceTypeWithConstruct(typeElement,sourceClassName, packageName, className));
    genJavaSourceFile(packageName,typeElement.getAnnotation(GenGetParam.class).sourcePath(),builder);
  }
}
